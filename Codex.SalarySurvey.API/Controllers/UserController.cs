...
namespace Codex.SalarySurvey.API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        // POST: api/user/phone/code/{phone}
        /// <summary>
        /// Sends SMS verification code to the given phone number.
        /// </summary>
        /// <param name="phone">Phone number</param>
        /// <returns>Feedback status</returns>
        [HttpPost("phone/code/{phone}")]
        public ActionResult SendSmsVerificationCode([Phone] string phone)
        {
            _userService.SendSmsVerificationCode(phone);
            return Ok();
        }
    }
}
