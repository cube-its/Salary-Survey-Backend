...
namespace Codex.SalarySurvey.Domain
{
    public class UserService : IUserService
    {
        ...
        private readonly ICodexResourceManager _codexResourceManager;
        private readonly AppSettings _appSettings;

        public UserService(IUserRepository userRepository, IUnitOfWork unitOfWork, ICodexResourceManager codexResourceManager, IOptions<AppSettings> appSettingsAccessor)
        {
            _userRepository = userRepository;
            _unitOfWork = unitOfWork;
            _codexResourceManager = codexResourceManager;
        ...
        public User Register(User user)
        {
            ...
            string code = _codexResourceManager.SendSmsVerificationCode(user.Phone);
            ...
            else
            {
                ...
                // Check if the user already exists in the Codex database.
                user.IsCodexUser = _codexResourceManager.PhoneExists(user.Phone);
        ...
        {
            // Send SMS verification code to the given phone number.
            string code = _codexResourceManager.SendSmsVerificationCode(phone);
